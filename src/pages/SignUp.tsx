  ...
  if (isMobile) {
    return (
      <div className="min-h-screen w-full flex flex-col bg-gradient-to-b from-blue-50 to-blue-100">
        <div className="flex h-16 items-center border-b bg-white/80 backdrop-blur-sm px-4 md:px-6">
          <Link to="/" className="flex items-center gap-2">
            <Shirt className="h-6 w-6 text-primary" />
            <span className="font-semibold text-xl text-foreground">Closet Keeper</span>
          </Link>
        </div>
  ...
  return (
    <div className="flex min-h-screen w-full">
      ...
      <div className="hidden lg:block lg:w-1/2 xl:w-7/12 relative overflow-hidden">
        <div className="absolute inset-0 bg-gradient-to-br from-closet-blue to-closet-teal opacity-90 z-10" />
        <img 
