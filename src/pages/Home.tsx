    ...
    <Layout excludeSidebar>
      ...
      <section className="py-20 md:py-28 bg-secondary/20">
        <div className="container mx-auto px-4 md:px-6 lg:px-8 text-center">
          <div className="max-w-3xl mx-auto mb-10">
            <h1 className="stylestack-heading-xl mb-6">
              Organize your wardrobe <span className="text-primary">effortlessly</span>
            </h1>
            <p className="stylestack-body max-w-2xl mx-auto mb-8">
      ...
      <section className="py-16 bg-secondary/10">
        <div className="container mx-auto px-4 md:px-6 lg:px-8">
          <h2 className="stylestack-heading-lg text-center mb-16">
            Key Features
          </h2>
      ...
      {/* CTA Section */}
      <section className="py-20 bg-primary/8">
        <div className="container mx-auto px-4 md:px-6 lg:px-8 text-center">
          <h2 className="stylestack-heading-lg mb-6">
            Ready to Transform Your Wardrobe Experience?
          </h2>
          <p className="stylestack-body max-w-3xl mx-auto mb-10 opacity-90">
            Join thousands of users who have simplified their clothing management with Closet Keeper.
          </p>
          <Link to="/sign-up">
            <Button size="lg" className="morphism-button text-primary border-primary/20 hover:bg-primary/10">
...
const FeatureCard = ({ icon: Icon, title, description }) => (
  <div className="bg-card/80 backdrop-blur-sm border border-border/50 p-6 rounded-2xl hover:scale-105 transition-all duration-300 shadow-sm">
    <div className="inline-flex items-center justify-center p-3 mb-4 bg-primary/10 text-primary rounded-full">
      <Icon className="h-6 w-6" />
    </div>
    <h3 className="stylestack-heading-sm mb-3">{title}</h3>
    <p className="stylestack-body">{description}</p>
  </div>
);

const TestimonialCard = ({ quote, author }) => (
  <div className="bg-card/80 backdrop-blur-sm border border-border/50 p-6 rounded-2xl">
    <div className="text-4xl text-primary opacity-30">"</div>
    <p className="mt-4 mb-4 stylestack-body">{quote}</p>
