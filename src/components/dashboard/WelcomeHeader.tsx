    ...
    <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-8">
      <div className="animate-fade-in">
        ...
        <p className="text-muted-foreground mt-1">
          ...
          {laundryCount > 0 && (
            <span className={cn(
              "text-closet-coral dark:text-closet-coral/90 ml-1 font-medium",
              "transition-all duration-300 hover:text-closet-coral/80"
            )}>
      ...
      <div className="flex gap-2 items-center animate-slide-in">
        <div className="relative w-full sm:w-auto">
          ...
          <input
            ...
            className="h-10 w-full min-w-[200px] rounded-full border border-input bg-background pl-10 pr-4 text-sm ring-offset-background focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring transition-all duration-300 focus:shadow-sm"
          />
        </div>
